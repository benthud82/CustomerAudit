    ...
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12  col-print-4">
        ...
        <section class="panel">
            ...
            <div class="list-group">
                ...
                <div class="list-group-item"> 
                    <span class="pull-right"><i id="extlink_tntaudit" class="fa fa-external-link" style="margin-right: 5px; cursor: pointer;"></i><strong id="ontimemnt"><?php echo $ONTIMEMNT ?></strong></span> 
                    On Time Delivery
                </div>

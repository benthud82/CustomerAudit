...
$auditcountsql = $conn1->prepare("SELECT 
                                                            ...
                                                            WHERE
                                                                auditcomplete_custtype = 'SALESPLAN'
                                                                    AND auditcomplete_custid = '$var_salesplan'
    ...
    <div class="row">
        <div  id="auditcompleterow">
            ...
            <div class="col-md-12 col-lg-6">
                <div class="alert alert-info "><h5><i class='fa fa-info-circle fa-lg'></i> This Sales Plan has been audited in the last 90 days.  <a href="audithistory.php?salesplan=<?php echo $var_salesplan; ?> " target="_blank"> Click to view history <i class='fa fa-external-link'></i>  </a> </h5></div>
            </div>
        </div>
    </div>

...
$var_cust = $_POST['billto'];  //transfers over as bill to, but this is the salesplan

$result1 = $conn1->prepare("SELECT * FROM customerscores_billto WHERE BILLTONUM LIKE '$var_cust'");
$result1->execute();

foreach ($result1 as $row) {
    //are all of these in the customerscores_salesplan table?
    $BILLTO = $row['BILLTONUM'];
